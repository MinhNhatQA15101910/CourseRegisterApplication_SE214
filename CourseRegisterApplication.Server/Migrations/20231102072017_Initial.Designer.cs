...
namespace CourseRegisterApplication.Server.Migrations
{
    ...
    [Migration("20231102072017_Initial")]
            ...
            modelBuilder.Entity("CourseRegisterApplication.Shared.Branch", b =>
                {
                    ...
                    b.Property<string>("BranchNameId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("BranchNameId")
                        .IsUnique()
                        .HasFilter("[BranchNameId] IS NOT NULL");
            ...
            modelBuilder.Entity("CourseRegisterApplication.Shared.Department", b =>
                {
                    ...
                    b.Property<string>("DepartmentNameId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DepartmentNameId")
                        .IsUnique()
                        .HasFilter("[DepartmentNameId] IS NOT NULL");
